...
# Variables
SRC		= linked.c ft_split.c push_swap.c swap.c push.c rotate.c reverse.c sorting_1.c big_sort.c big_sort_help1.c big_sort_help2.c sorting_2.c linked_2.c push_swap_2.c
CC		= cc
OBJS	= $(SRC:.c=.o)
